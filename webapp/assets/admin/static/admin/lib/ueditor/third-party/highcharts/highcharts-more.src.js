...
seriesTypes.boxplot = extendClass(seriesTypes.column, {
	...
	/**
	 * One-to-one mapper from options to SVG attributes
	 */
	pointAttrToOptions: { // mapper between SVG attributes and the corresponding options
		fill: 'fillColor',
		stroke: 'color',
...
seriesTypes.waterfall = extendClass(seriesTypes.column, {
	...
	/**
	 * Postprocess mapper between options and SVG attributes
	 */
	getAttribs: function () {
