<%@ page import="cn.edu.guet.cake.blog.web.pojo.Article" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/user/statics/css/detail.css"/>
</head>

<body class="home blog custom-background round-avatars" itemscope itemtype="http://schema.org/Organization">
<div class="Yarn_Background" style="background-image: url(${basePath}assets/user/statics/images/47fb3c_.jpg);"></div>
...
<header id="masthead" class="overlay animated from-bottom" itemprop="brand" itemscope
    ...
    <div class="site-branding text-center">
        <a href="">
            <figure>
                <img class="custom-logo avatar" src="assets/user/statics/images/omikron.png"/>
            </figure>
        </a>
        ...
        <article id="post-1202"
            ...
            <section class="post_content">
                <header class="post_header">
                    <h1 class="post_title"><%=((Article) request.getAttribute("article")).getTitle()%>
                    </h1>
                </header>
                <div class="post-body js-gallery">
                    <div id="doc-content">
                        <textarea
                            ...
                            <%=((Article) request.getAttribute("article")).getUpdatetime()%>
                        </textarea>
                    </div>
                    ...
                    <%--<p>回来，几月不正经写--%>
                    <%--<a class='autotag' href="" title="【查看含有[更新]标签的文章】" target="_blank">更新</a>文，不会就这样吧啦几句就跑的，说回正事；当前--%>
                    <%--Yarn 也差不多使用了一年的时间，发售也同样一年了，起初不做任何宣传的情况下，也有几十份的出售，默默地挂着，等待下一个“有缘人”，最近被推倒了--%>
                    <%--<a class='autotag' href="" title="【查看含有[主题]标签的文章】" target="_blank">主题</a>网，突然间询问的人多了起来，然而少数的是购买者，无用功的时间有点多啊，怎么说也是该感谢，因为至少被人认可是件让我觉得值得和高兴的事。更多的，我该感谢的是每一位用户和每一次用心给我反馈的用户，因为我始终认为别人的时间是金钱，别人能在这这浪费时间说明至少我的作品还是存在一定的“等价”价值，这也是每一次的版本更新我都会在邮件结尾以“感谢大家对--%>
                    <%--Yarn 的认可和支持”致谢的原因。他们说这个价格，可能不是强大的，但最好看最有个性的就是 Yarn 了， 69 元买不了吃亏，买不了上当！</p>--%>
                    <%--<a href="" class="blog-card-title-link">--%>
                    <%--<div class="blog-card">--%>
                    <%--<div class="blog-card-thumbnail"><img width="150" height="150"--%>
                    <%--src="assets/user/statics/images/yarn-150x150.jpg"--%>
                    <%--class="blog-card-thumb-image wp-post-image" alt=""/>--%>
                    <%--</div>--%>
                    <%--<div class="blog-card-content">--%>
                    <%--<div class="blog-card-date clearfix">2016-10-19 09:46</div>--%>
                    <%--<div class="blog-card-title">关于购买Yarn</div>--%>
                    <%--<div class="blog-card-excerpt">--%>
                    <%--首先说明一下，Yarn是本人第一款付费主题，用心用力，只为小众，不卖代码。函数各种代码满网络可找，设计可以千差万别。Yarn定位是清新、单栏、个性，如果你想要的是一款与众不同的主题，那么Yarn是您的--%>
                    <%--</div>--%>
                    <%--</div>--%>
                    <%--</div>--%>
                    <%--</a>--%>
                    ...
                    <%--<a href="assets/user/statics/images/Dcras.png"><img--%>
                    <%--src="assets/user/statics/images/Dcras.png" alt="" width="1920"--%>
                    <%--height="1080"--%>
                    <%--class="alignnone size-full wp-image-1223"/></a>--%>
                    <%--</quote>--%>
                    <%--国庆期间有了 Dcras 这个想法，现阶段只是试点代码实现了头部和部分的文章样式（草图画成这屌样就敢动工也是服），试着尝试一下我最不喜欢的三栏目布局，悦目的动效一直是我做主题追求的，所以这次--%>
                    ...
                    <ul class="commentwrap">
                        <li class="comment even thread-even depth-1" id="li-comment-">
                            <div id="comment-969" class="comment_body contents">
                                <div class="profile">
                                    <a href=""><img
                                            src="assets/user/statics/images/9cc50a9e422fb1c89aebafeb959cef7a.jpg"
                                            class="gravatar" alt="小布丁"></a>
                                </div>
                        ...
                        <form action="#" method="post" id="commentform" class="clearfix">
                            ...
                            <div class="comment-form-info">
                                <div class="real-time-gravatar"><img id="real-time-gravatar"
                                                                     src="assets/user/statics/images/d41d8cd98f00b204e9800998ecf8427e.png"
                                                                     alt="gravatar头像"/>
                                </div>
                                <p class="input-row">
                                    <i class="row-icon"></i>
...
<div class="p-header">
    <figure class="p-image"
            style="background-image: url(${basePath}assets/user/statics/images/47fb3c_9afed6c259f94589881bd55376206366mv2_d_3840_5784_s_4_2.jpg);"></figure>
</div>
        ...
        <div class="prev" data-aos="slide-right" data-aos-delay="1.5s">
            ...
            <div class="preview">
                <div class="pull-left featuredImg"
                     style="background-image:url(${basePath}assets/user/statics/images/97a354cb9519f97e84139f26017386026b3fd7f517b96-DCDbdE-250x250.jpeg);"></div>
        ...
        <div class="next" data-aos="slide-left" data-aos-delay="1.5s">
            ...
            <div class="preview">
                <div class="pull-right featuredImg"
                     style="background-image:url(${basePath}assets/user/statics/images/no-image.png);"></div>
...
<footer id="footer" class="overlay animated from-top">
    ...
    <div class="socialize" data-aos="zoom-in">
        ...
        <li class="wechat">
            ...
            <div class="wechatimg"><img src="assets/user/statics/images/49D3746D-7519-B709-83E4-65BD1927C4E7.jpg"></div>
        </li>
        <li>
    ...
    <script type='text/javascript' src='assets/user/statics/js/jquery.min.js'></script>
    <script src="assets/admin/mdeditor/lib/marked.min.js"></script>
    <script src="assets/admin/mdeditor/lib/prettify.min.js"></script>
    <script src="assets/admin/mdeditor/lib/raphael.min.js"></script>
    <script src="assets/admin/mdeditor/lib/underscore.min.js"></script>
    <script src="assets/admin/mdeditor/lib/sequence-diagram.min.js"></script>
    <script src="assets/admin/mdeditor/lib/flowchart.min.js"></script>
    <script src="assets/admin/mdeditor/lib/jquery.flowchart.min.js"></script>
    <script src="assets/admin/mdeditor/editormd.min.js"></script>

    <script type='text/javascript' src='assets/user/statics/js/plugins.js'></script>
    <script type='text/javascript' src='assets/user/statics/js/script.js'></script>
    <script type='text/javascript' src='assets/user/statics/js/particles.js'></script>
    <script type='text/javascript' src='assets/user/statics/js/aos.js'></script>
    <script type='text/javascript' src='assets/user/statics/js/prism.js'></script>
    <script type='text/javascript' src='assets/user/statics/js/gravatar.js'></script>
</footer>
</body>
<script type="text/javascript">
