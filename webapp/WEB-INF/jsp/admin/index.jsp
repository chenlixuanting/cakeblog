				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="admin/menu1" data-id='1' data-text="后台菜单"><span class="l-line"></span>后台菜单</a></dd>
				      <dd><a href="javascript:;" data-url="admin/menu2" data-id='2' data-text="前台菜单"><span class="l-line"></span>前台菜单</a></dd>
				    </dl>
				  </li>
				  <li class="layui-nav-item">
				    <a href="javascript:;"><i class="iconfont">&#xe608;</i>文章管理</a>
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="admin/article-info-manage" data-id='3' data-text="完善信息项管理"><span class="l-line"></span>完善信息项管理</a></dd>
				  ...
				  <li class="layui-nav-item">
				   ...
				   <li class="layui-nav-item">
				    <a href="javascript:;" target="_blank"><i class="iconfont">&#xe60c;</i>友情链接</a>
				  </li>
				   <li class="layui-nav-item">
