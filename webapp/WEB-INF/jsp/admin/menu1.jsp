    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            <div class="layui-inline tool-btn">
                <button class="layui-btn layui-btn-small layui-btn-normal addBtn hidden-xs" data-url="admin/menu-add"><i
    ...
    <div class="layui-form" id="table-list">
        <table class="layui-table" lay-skin="line">
            ...
            <tr id='node-1' class="parent collapsed">
                ...
                <td class="hidden-xs"><input type="text" name="title" autocomplete="off" class="layui-input" value="0"
                                             data-id="1"></td>
                ...
                <td>
                    <button class="layui-btn layui-btn-mini layui-btn-normal table-list-status">显示</button>
                </td>
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
            ...
            <tr id='node-2' class="child-node-1 parent collapsed" style="display:none ;" parentid="1">
                ...
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="2"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="2"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
            <tr id='node-3' class="child-node-2 parent collapsed" style="display: none;" parentid="1">
                ...
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="3"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="3"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
            <tr id='node-4' class="child-node-2 parent collapsed" style="display: none;" parentid="1">
                ...
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="4"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="4"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
            ...
            <tr id='node-5' class="child-node-1 parent collapsed" style="display: none;" parentid="1">
                ...
                <td>
                    <button class="layui-btn layui-btn-mini layui-btn-warm table-list-status">隐藏</button>
                </td>
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="5"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="5"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
            <tr id='node-6' class="child-node-5 parent collapsed" style="display: none;" parentid="1">
                ...
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="6"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="6"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
            <tr id='node-7' class="child-node-5 parent collapsed" style="display: none;" parentid="1">
                ...
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1"
                                data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="7"
                                data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
                        <button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="7"
                                data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
